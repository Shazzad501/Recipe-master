...
const Banner = () => {
  return (
    <div className='banner py-24 w-11/12 mt-5 rounded-lg mx-auto text-center flex flex-col items-center justify-center'>
      <h2 className='font-extrabold text-6xl text-white'>Discover an exceptional cooking <br className='hidde md:block' /> class tailored for you!</h2>
